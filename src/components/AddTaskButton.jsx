  ...
  return (
    <div className="mt-5">
      <button
        ...
        className="mb-4 p-2 bg-blue text-white rounded flex flex-row"
      >
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal}>
        <div className="flex flex-col">
          <input
            type="text"
            className="border border-blue rounded-md py-2 px-5 mb-3"
          ...
          />
          <button
            className="bg-blue text-white border-0 rounded-md w-full text-center text-sm font-semibold py-2 cursor-pointer"
